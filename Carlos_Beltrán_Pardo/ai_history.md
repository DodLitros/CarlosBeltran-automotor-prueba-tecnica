...
2. **Diseñar el mejor prompt inicial**: Para esto he usado chatgpt con el fin de encontrar la mejor estructura para un proyecto como este, teniendo en cuenta sus recomendaciones, empecé a escribir el prompt para pasarselo a un agente de terminal, en este caso Opencode; a sabiendas de que éste podía acceder a todo el repositorio, y a partir de un prompt con especificaciones claras, construir desde 0 el código y la arquitectura del proyecto. [text](https://chatgpt.com/share/6a2328e5-4d70-83e9-879a-15891607bc83)
